...
//	{BUSMCLK_DIVIDER, 0xFF, 0x03},
	...
	/* set SRC A/B Sync Domain to select SYNC7 */
	{SYNC_DOMAIN_SELECTOR7, 0x77, 0x77},

	/* set SRC C/D Sync Domain to select SYNC5 */
	{SYNC_DOMAIN_SELECTOR8, 0x77, 0x55},
